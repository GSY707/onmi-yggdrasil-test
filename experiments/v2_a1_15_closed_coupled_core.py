...
from yggdrasil_v2.reasoning_medium.a1_15_assessment import assess_a115
...
def parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(description="V2-A1.15 closed query-coupled core")
    ...
    assess.add_argument("--a113-assessment", type=Path, required=True)
...
def main() -> None:
    ...
    if args.command == "train":
        ...
        result = assess_a115(args.a113_assessment, args.run_dir, args.output)
