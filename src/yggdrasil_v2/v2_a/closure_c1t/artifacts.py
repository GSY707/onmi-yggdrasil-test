...
"""C1T source closure, single-use leases, snapshots, and evidence seals."""
...
SOURCE_FILES = (
    contract.DESIGN_DOC,
    contract.S0_EXECUTION_DOC,
    contract.S1_EXECUTION_DOC,
    Path("experiments/v2_a_closure_c1t.py"),
    Path("src/yggdrasil_v2/__init__.py"),
    Path("src/yggdrasil_v2/v2_a/__init__.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/__init__.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/artifacts.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/cache.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/cards.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/contract.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/evaluate.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/model.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/objective.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/runner.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/runtime.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/s0.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/s1.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/source.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/tasks.py"),
    Path("src/yggdrasil_v2/v2_a/closure_c1t/train.py"),
    ...
    Path("tests/v2_a_closure_c1t/test_contract_tasks.py"),
    Path("tests/v2_a_closure_c1t/test_model_objective.py"),
    Path("tests/v2_a_closure_c1t/test_runtime_evaluate_runner.py"),
    Path("tests/v2_a_closure_c1t/test_source_cache.py"),
    Path("tests/v2_a_closure_c1t/test_s0_runner.py"),
    Path("tests/v2_a_closure_c1t/test_s1_training.py"),
)
...
def source_hashes(repo_root: Path) -> dict[str, str]:
    ...
    if missing:
        raise FileNotFoundError(f"C1T source identity is incomplete: {missing}")
...
def audit_evidence_seal(
    ...
    try:
        ...
        checks = {
            ...
            "identity": expected_identity is None or payload.get("identity") == expected_identity,
