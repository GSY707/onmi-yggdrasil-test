...
"""Gauge-invariant C1U mechanism metrics and fail-closed S1 gates."""
...
def collect_prediction_rows(model: C1UModel, batch: Mapping[str, Any]) -> dict[str, Any]:
...
def qualify_s1(
    ...
    *,
    ...
    return {
        ...
        "status": "PASS_C1U_S1" if passed else "FAIL_C1U_S1_QUALIFICATION",
        "passed": passed,
...
def evaluate_s1(model: C1UModel, batch: Mapping[str, Any]) -> dict[str, Any]:
