...
| `artifacts/omni_transformer_stage_avjb_trace_verifier/*_checkpoints/` | Stage AV-J-B smoke/capacity checkpoint 目录；大型训练应另用 `train_70m_checkpoints` |
...
| `docs/omni-transformer-stage-avjb-trace-verifier.md` | Stage AV-J-B 长链 trace/verifier 训练准备报告，记录 rich trace、copy-vs-update gate、record verifier、answer loss 后移、CPU/CUDA smoke、70M capacity、长训命令、门槛和担忧 |
...
| Stage AV-J-B 长链 trace/verifier、copy-vs-update gate、字段级 target 指标、answer loss 后移和 70M 长训入口 | `docs/omni-transformer-stage-avjb-trace-verifier.md`、`experiments/omni_transformer_stage_avjb_trace_verifier.py`、`tests/test_stage_avjb_trace_verifier.py`、`artifacts/omni_transformer_stage_avjb_trace_verifier/cpu_smoke_result.json`、`artifacts/omni_transformer_stage_avjb_trace_verifier/cpu_resume_smoke_result.json`、`artifacts/omni_transformer_stage_avjb_trace_verifier/cuda_capacity_smoke_result.json` 与 `artifacts/omni_transformer_stage_avjb_trace_verifier/capacity_70m_batch256_2step_result.json` |
